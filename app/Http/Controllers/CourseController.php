...
class CourseController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $rules = [
            ...
            'mentor_id' => 'required|exists:mentors,id', // Validasi keberadaan mentor
            'description' => 'string'
        ];
        ...
        // Buat course baru menggunakan data yang diberikan
        $course = Course::create($data);

        // Kembalikan response sukses bersama dengan data course yang baru dibuat
        return response()->json([
            'status' => 'success',
            'data' => $course
        ], 201); // Kode status 201 menunjukkan "Created"
    }
